...
public final class Settings {
    ...
    private static final Map<String, String> FALLBACK_MESSAGES = Map.ofEntries(
            ...
            Map.entry("locked", "<red>{item} 尚未解锁 —— 先向商店卖出 1 个，即可永久解锁购买</red>"),
            ...
            Map.entry("quota-lifetime", "<red>{item} 终身限售 <white>{limit}</white> 个，已用完（永不重置）</red>"),
            ...
            Map.entry("admin-reset-unlock", "<green>已清除 <white>{player}</white> 的终身计数</green>"),
